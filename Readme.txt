  ...
  #  AeroZoom Panel is made of large buttons designed to quickly toggle 
     sub-magnifier settings or to add more functions. Upon calling with
     mouse, it pops up where the cursor is, without the need of locating
  ...
  #  Switching to ZoomIt Panel improves mouse operation of Sysinternals
     ...
     - A handy list of ZoomIt keyboard shortcuts at hand.

     - Elastic Zoom, live or still. (See following)
  

     [ Elastic Zoom - enhances Windows 7 Magnifier or ZoomIt ]

  #  Automatically zoom in and out by holding and releasing same hotkey

     - Elastic Zoom allows zooming in and out just by holding and
       releasing the same hotkey [Ctrl]+[Caps Lock], simplifying the
       whole zoom procedure.
  ...
  #  AeroZoom binds common keyboard controls to these mouse buttons
     ...
     Hotkey-all on|off    => (Single-click on tray icon)
  ...
  1. Windows Media Center users may face an issue where the cursor
     ...
     Magnifier. Users may work around it by clicking 'Kill' on the
     panel or use the default hotkey to kill magnifier: Win+Shift+K,
     or redefine the middle button action as 'Kill'. To do that, go 
     to 'Tool > Custom Hotkeys > Settings > Holding Middle' and 
     set its action to 'Kill'.

  2. WizMouse is only semi-compatible with AutoHotkey--the language
     AeroZoom is based on. From the WizMouse doc: "Some users
     ...
     Tip 1: Clicking on any Ctrl/Shift/Alt/Left/Right/Middle/F/B
     button on the AeroZoom Panel restarts (brings back) AeroZoom.

     Tip 2: (Since v3.2) Clicking the tray icon 3 times does it too.
	 
     Tip 3: Go to WizMouse's Settings and check 'Left click tray
     icon to enable/disable', so that left-clicking WizMouse's tray
     icon quickly disables WizMouse and enables AeroZoom, or vice
     versa.
  ...
  3. Multi-monitor configurations should work okay with AeroZoom.
     ...
     cursor, adjust panel offset manually in 'Tool > Preferences
     > Advanced Options'.


     [ Limitations ]
  
  #  If you've encountered any bugs or any of the following limits 
     but think it is a bug. Please email wandersick@gmail.com
