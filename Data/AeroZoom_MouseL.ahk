...
; Menu, FileMenu, Add, &Show magnifier`t[Left]+[Wheel-up], EnableAZ
; Menu, FileMenu, Add, &Kill magnifier`t, DisableAZ
; Menu, FileMenu, Add, &Restore defaults, ResetDefaultsAZ
; Menu, FileMenu, Add, &Reset zoom`t[Left]+[Middle], ResetZoomLevelAZ
...
Gui, 2:Add, Text, , Mouse Buttons Instructions (Right-handed version)
Gui, 2:Font, s10, Arial, 
Gui, 2:Add, Text, , This panel`t=> [Left] + [Right]`nShow magnifier`t=> [Left] + [Wheel-up]`nReset zoom`t=> [Left] + [Middle]`nZoom in  `t=> hold [Left] + [Wheel-up]`nZoom out`t=> hold [Left] + [Wheel-down]
Gui, 2:Font, norm, 
