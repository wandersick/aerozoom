...
~XButton1 & LButton:: ; this is the same as holding the Middle button except you dont need to hold it
if not (paused=1) {
	Process, Exist, ZoomIt.exe
	If errorlevel
	{
...
~XButton2 & LButton:: ; Break Timer if ZoomIt is enabled; otherwise, toggle Color
if not (paused=1) {
	Process, Exist, ZoomIt.exe
	If errorlevel
	{	
...
~XButton2 & MButton:: ; this resets the zoom increment only
if (paused=1)
	return
...
~XButton2 & RButton:: ; show magnifier
if (paused=1)
	return
Gosub, ZoomPad
...
~XButton2 & Wheelup:: ; increase the zoom increment one step
if (paused=1)
	return
Gosub, ZoomPad
IfWinExist, ahk_class AutoHotkeyGUI, AeroZoom
...
~XButton2 & Wheeldown:: ; decrease the zoom increment one step
if (paused=1)
	return
Gosub, ZoomPad
IfWinExist, ahk_class AutoHotkeyGUI, AeroZoom
