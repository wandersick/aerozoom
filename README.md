...
For AeroZoom to work under older versions of Windows 11 (current versions are unaffected), it may be be required to disable User Account Control (UAC) using the registry edit method as follows:
